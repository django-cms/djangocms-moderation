...
DEFAULT_CONFIRMATION_VIEW_TEMPLATE = getattr(settings, 'CMS_MODERATION_DEFAULT_CONFIRMATION_VIEW_TEMPLATE', 'djangocms_moderation/moderation_confirmation.html')

CORE_CONFIRMATION_VIEW_TEMPLATES = (
    (DEFAULT_CONFIRMATION_VIEW_TEMPLATE, _('Default')),
)

CONFIRMATION_VIEW_TEMPLATES = getattr(settings, 'CMS_MODERATION_CONFIRMATION_VIEW_TEMPLATES', CORE_CONFIRMATION_VIEW_TEMPLATES)