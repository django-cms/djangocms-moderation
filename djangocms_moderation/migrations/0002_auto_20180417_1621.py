# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-04-17 15:21
from __future__ import unicode_literals

from django.db import migrations, models
import django.db.models.deletion
import djangocms_moderation.backends
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(default=djangocms_moderation.backends.default_workflow_reference_number_backend, max_length=32, unique=True),
        ),
        migrations.AddField(
            model_name='workflow',
